      ...
      <div className="flex flex-col h-full">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm mb-4">
          ...
          <div>
            ...
            {brewer.filterType.charAt(0).toUpperCase() + brewer.filterType.slice(1)}
          </div>
          <div>
          ...
          <div>
            <span className="text-gray-500 dark:text-gray-400">Grind Size:</span>{" "}
            {brewer.recommendedGrindSize}
          </div>
          <div>
            <span className="text-gray-500 dark:text-gray-400">Brew Time:</span>{" "}
            {formatTime(brewer.brewTime.min)} - {formatTime(brewer.brewTime.max)}
          </div>
          {brewer.pressure && (
